let secretNumber;
        ...
        function createSecret() {
            secretNumber = prompt("Please enter the Password :");
        }

        function checkSecret() {
            let userInput = document.getElementById("secretInput").value;
...
wss.on('connection', (socket) => {
  socket.on('message', (message) => {
    // Hier können Sie die Logik für die Kommunikation mit den Clients implementieren
  });
});
